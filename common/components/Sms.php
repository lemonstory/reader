...
require_once Yii::$app->vendorPath . '/aliyun-sms-php-sdk/api_sdk/vendor/autoload.php';
...
class Sms extends Component
{
    ...
    public function __construct($accessKeyId = '', $accessKeySecret = '')
    {
        ...
        $this->accessKeyId = !empty($accessKeyId) ? $accessKeyId : Yii::$app->params['smsAccessKeyId'];
        $this->accessKeySecret = !empty($accessKeySecret) ? $accessKeySecret : Yii::$app->params['smsAccessKeySecret'];
